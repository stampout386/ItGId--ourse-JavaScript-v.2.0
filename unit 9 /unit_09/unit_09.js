...
function f14() {
  ...
  out14.prepend(div14);  // добавляет div14 к началу
}
...
let par18 = document.querySelector('.p-18');
let out18 = document.querySelector('.out-18');
document.querySelector('.b-18').onclick = f18;
function f18() {
   out18.innerHTML = par18.getAttribute('data-b');
...
function f20() {
   ...
   //div20.innerHTML = div20.getAttribute('title');
}

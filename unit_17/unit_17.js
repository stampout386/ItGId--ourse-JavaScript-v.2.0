...
function t14() {
    ...
    function toLowerCase (){ a14.forEach(function(elem,index){
        a14[index] =  elem.toLowerCase(); 
    })
      return a14;
    }
    toLowerCase ();
    let a14sym = a14_sym.toLowerCase();

    return a14.includes(a14sym);

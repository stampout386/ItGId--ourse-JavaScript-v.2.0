...
let i6 = document.querySelector('.i-6'); // Элемент управления, которые не отображается, но чье значение отправлено на сервер
...
function f8() {
    div8.innerHTML = '<button class="b-81">GO</button>';
    div8.innerHTML += '<input type="text" class = "i-81"/>';
...
function f10() {
   let a10 = i10.value;
   div10.style.backgroundColor = a10;
}
...
function f15() {
    let a15 = i15.value;
    t15.value = a15;  // еще можно написать t15.innerHTML = a15 ; вроде бы тот же эффект.
    div15.innerHTML = a15;
}
...
function f20(e) {
    ...
    let a20 = form.elements['username'].value;
    let b20 = form.elements['password'].value;
    div20.innerHTML = a20 + ' ' + b20;

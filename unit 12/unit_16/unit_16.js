...
function f4() {
 ...
 for (const iterator of divS) {
     iterator.innerHTML = iterator.innerHTML + '4' ;
 }
}
...
function f9() {
    ...
    for (const iterator of a9) {
        if (maxLength < iterator.length){
            maxLength = iterator.length-1;
        }
    }
   return maxLength;
}
